...
total_choices=9.99 //UPDATE THIS WHEN ADDING NEW CHOICE
...
instance_create_depth(cx+240,cy+400,depth-10,btn_lvl_upgrade).my_id=slot_1
instance_create_depth(cx+240,cy+480,depth-10,btn_lvl_upgrade).my_id=slot_2
instance_create_depth(cx+240,cy+560,depth-10,btn_lvl_upgrade).my_id=slot_3
